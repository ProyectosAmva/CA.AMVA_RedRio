...
/// </summary>
  ...
  private readonly IRepositoryHistorialExcel<HistorialExcel> _historialExcelRepository;
    ...
    public HistorialExcelController(IRepositoryHistorialExcel<HistorialExcel> historialExcelRepository)
    {
        ...
        public async Task<ActionResult<Response>> GetAllHistorialExcels()
        {
            try
            {
                var historialExcels = await _historialExcelRepository.GetAllAsync();
        ...
        public async Task<ActionResult<Response>> GetByIdHistorialExcel(int id)
        {
            try
            {
                var historialExcel = await _historialExcelRepository.GetByIdAsync(id);
        ...
        [HttpGet("ObtenerHistorialExcelPorCampaña/{idCampaña}")]
                public async Task<ActionResult<Response>> GetByCampañaAsync(int idCampaña)
                {
                    try
                    {
                        var HistorialExcel = await _historialExcelRepository.GetByCampañasAsync(idCampaña);
    ...
    public async Task<ActionResult<Response>> AddHistorialExcel([FromForm] IFormFile file, [FromForm] int IdUsuario, [FromForm] int IdCampaña)
    {
        ...
        public async Task<IActionResult> UpdateHistorialExcel(int id, [FromBody] HistorialExcel historialExcel)
        {
            try
            {
                var existingHistorialExcel = await _historialExcelRepository.GetByIdAsync(id);
                ...
                await _historialExcelRepository.UpdateAsync(existingHistorialExcel);
